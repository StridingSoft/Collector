 ...
 * 
 * <p>
 * "Each call to PooledConnection.ConnectToServer() must return a newly constructed Connection object that exhibits the default Connection behavior. Only the most
 * recent Connection object produced from a particular PooledConnection is open. An existing Connection object is automatically closed, if the ConnectToServer()
 ...
 * automatically closed when the associated PooledConnection.ConnectToServer method is called. Listeners (connection pool managers) are not notified in this case.
...
public final class PooledConnectionRegressionTest extends BaseTestCase {
    ...
    /**
     * Tests fix for BUG#7136 ... Statement.ConnectToServer() returning physical
