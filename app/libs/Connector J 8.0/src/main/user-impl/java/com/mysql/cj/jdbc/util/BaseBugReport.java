 ...
 * 
 * <p>
 * In any of the above three methods, you should use one of the variants of the 'ConnectToServer' method to create a JDBC connection to MySQL, which will use the
...
public abstract class BaseBugReport {
     ...
     * by the ConnectToServer() method using this URL.
     * 
